...
/**
 * <p>
 * Java-Klasse für AwaitMoveMessageType complex type.
 * 
 * <p>
...
@XmlType(name = "AwaitMoveMessageType", propOrder = { "board", "treasuresToGo", "foundTreasures", "treasure" })
public class AwaitMoveMessageType {
	 ...
	 * 
	 * @return possible object is {@link BoardType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link BoardType }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the treasuresToGo property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the foundTreasures property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
